            ...
            return new Promise(function(resolve, reject) {
                if(type == 'oauth'){
                    if(this._tokens.oauth.refresh_token){
                        var oauth_expire = new Date(new Date(this._tokens.oauth.issued).getTime() + (this._tokens.oauth.expires_in*1000))
                    ...
                    if(this._tokens.user.Token){
                        var oauth_expire = new Date(this._tokens.user.NotAfter).getTime()
